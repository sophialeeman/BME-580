...
df_f <- subset(df_f, select = -c(Case_Fatality_Ratio, Incident_Rate, Year, Indicator, State, Month))
df_i <- subset(df_i, select = -c(Case_Fatality_Ratio, Incident_Rate, State, Month, Year, Indicator))
...
cumVar_i
```
This accounts for about 65% of the variance.
...
tf_f <- subset(tf_f, select = -c(Case_Fatality_Ratio, Incident_Rate, Year, Indicator, State, Month))
...
tf_i <- subset(tf_i, select = -c(Case_Fatality_Ratio, Incident_Rate, Year, Indicator, State, Month))
