...
```{r}
ag_scale <- ag[ -c(1) ]
colnames(ag_scale) <- c("Diastolic BP", "Systolic BP", "Heart Rate", "BPM", "Mean RR", "MxDMn", "SDNN", "rMSSD", "PNN50", "Moda", "AMo50", "LF", "HF", "VLF", "LF/HF", "Total Power", "Height", "Weight", "Age Range", "Symptom Severity", "Temperature", "Atmospheric Pressure", "Precipitation Intensity", "Humidity", "Clouds")
