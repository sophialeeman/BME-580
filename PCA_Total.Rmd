...
df_f <- subset(df_f, select = -c(Case_Fatality_Ratio, Incident_Rate, Confirmed, Deaths, Total_Test_Results, Testing_Rate))
df_i <- subset(df_i, select = -c(Case_Fatality_Ratio, Incident_Rate, Confirmed, Deaths, Total_Test_Results, Testing_Rate))
```
...
The first 3 PC axes are significant and account for 58.5% of the total variation for the first dataset, and the first 4 PC axes are significant and account for 71.3% of the total variation for the second dataset. 
```{r}
library(PCAtest)
